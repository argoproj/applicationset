...
The propagation of Application changes to the cluster is managed by the [automated sync settings](https://argoproj.github.io/argo-cd/user-guide/auto_sync/), which are referenced in the ApplicationSet `template` field:
