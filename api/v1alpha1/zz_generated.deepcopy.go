...
func (in *ApplicationSetGenerator) DeepCopyInto(out *ApplicationSetGenerator) {
	*out = *in
	...
	if in.Metrix != nil {
		in, out := &in.Metrix, &out.Metrix
		*out = new(MetrixGenerator)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetrixGenerator) DeepCopyInto(out *MetrixGenerator) {
	*out = *in
	if in.Generators != nil {
		in, out := &in.Generators, &out.Generators
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetrixGenerator.
func (in *MetrixGenerator) DeepCopy() *MetrixGenerator {
	if in == nil {
		return nil
	}
	out := new(MetrixGenerator)
