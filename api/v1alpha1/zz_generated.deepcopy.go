...
func (in *SCMProviderGeneratorFilter) DeepCopyInto(out *SCMProviderGeneratorFilter) {
	*out = *in
	...
	if in.PullRequestBranchMatch != nil {
		in, out := &in.PullRequestBranchMatch, &out.PullRequestBranchMatch
		*out = new(string)
		**out = **in
	}
	if in.PullRequestLabelMatch != nil {
		in, out := &in.PullRequestLabelMatch, &out.PullRequestLabelMatch
		*out = new(string)
		**out = **in
	}
}
