...
func (in *ApplicationSetNestedGenerator) DeepCopyInto(out *ApplicationSetNestedGenerator) {
	*out = *in
	...
	if in.Matrix != nil {
		...
		*out = new(MatrixNestedGenerator)
		(*in).DeepCopyInto(*out)
	}
	if in.Union != nil {
		in, out := &in.Union, &out.Union
		*out = new(UnionNestedGenerator)
		(*in).DeepCopyInto(*out)
	}
...
func (in *ApplicationSetSpec) DeepCopyInto(out *ApplicationSetSpec) {
	*out = *in
	if in.Generators != nil {
		...
		*out = make([]ApplicationSetTopLevelGenerator, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationSetTopLevelGenerator) DeepCopyInto(out *ApplicationSetTopLevelGenerator) {
	*out = *in
	if in.List != nil {
		in, out := &in.List, &out.List
		*out = new(ListGenerator)
	...
	if in.Matrix != nil {
		in, out := &in.Matrix, &out.Matrix
		*out = new(MatrixTopLevelGenerator)
		(*in).DeepCopyInto(*out)
	}
	if in.Union != nil {
		in, out := &in.Union, &out.Union
		*out = new(UnionTopLevelGenerator)
		(*in).DeepCopyInto(*out)
	}
	if in.SCMProvider != nil {
		in, out := &in.SCMProvider, &out.SCMProvider
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationSetTopLevelGenerator.
func (in *ApplicationSetTopLevelGenerator) DeepCopy() *ApplicationSetTopLevelGenerator {
	if in == nil {
		return nil
	}
	out := new(ApplicationSetTopLevelGenerator)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatrixNestedGenerator) DeepCopyInto(out *MatrixNestedGenerator) {
	*out = *in
	if in.Generators != nil {
		in, out := &in.Generators, &out.Generators
		*out = make(ApplicationSetTerminalGenerators, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatrixNestedGenerator.
func (in *MatrixNestedGenerator) DeepCopy() *MatrixNestedGenerator {
	if in == nil {
		return nil
	}
	out := new(MatrixNestedGenerator)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatrixTopLevelGenerator) DeepCopyInto(out *MatrixTopLevelGenerator) {
	*out = *in
	if in.Generators != nil {
		in, out := &in.Generators, &out.Generators
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatrixTopLevelGenerator.
func (in *MatrixTopLevelGenerator) DeepCopy() *MatrixTopLevelGenerator {
	if in == nil {
		return nil
	}
	out := new(MatrixTopLevelGenerator)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UnionNestedGenerator) DeepCopyInto(out *UnionNestedGenerator) {
	*out = *in
	if in.Generators != nil {
		in, out := &in.Generators, &out.Generators
		*out = make(ApplicationSetTerminalGenerators, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnionNestedGenerator.
func (in *UnionNestedGenerator) DeepCopy() *UnionNestedGenerator {
	if in == nil {
		return nil
	}
	out := new(UnionNestedGenerator)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UnionTopLevelGenerator) DeepCopyInto(out *UnionTopLevelGenerator) {
	*out = *in
	if in.Generators != nil {
		in, out := &in.Generators, &out.Generators
		*out = make([]ApplicationSetNestedGenerator, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnionTopLevelGenerator.
func (in *UnionTopLevelGenerator) DeepCopy() *UnionTopLevelGenerator {
	if in == nil {
		return nil
	}
	out := new(UnionTopLevelGenerator)
